...
spool inv_ora_schema_423_FP09.log;
...
insert into SCHEMA_VERS values ('Inventory 4.2.3', SYSDATE, 'PATCH', 'inv_ora_schema_423_FP09.sql', 'FP09 applied to existing installation');
commit;
